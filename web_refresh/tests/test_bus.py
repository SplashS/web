...
class TestBusBus(TransactionCase):
    ...
    def test_30_create(self):
        ...
        self.assertEqual({"res.partner": {0}}, self.env.registry.get_modified_records())
    ...
    def test_40_write_simple(self):
        ...
        partner.flush()
        self.assertEqual(
            {"res.partner": {0, partner.id}}, self.env.registry.get_modified_records()
        )
    ...
    def test_50_write_dependency(self):
        ...
        partner1.flush()
        self.assertEqual(
            {"res.partner": {0, partner1.id, partner2.id}},
            self.env.registry.get_modified_records(),
        )
